...
Перший запуск створює стартову колоду (419 англійських слів і фраз) у
...
```
dotnet publish src/Parrot.App -p:PublishProfile=win-x64
```

Результат — один самодостатній `artifacts/publish/Parrot.exe`, рантайм ставити
не треба.
...
tests/Parrot.Core.Tests  99 юніт-тестів на ядро
...
бібліотека з CRUD та імпортом/експортом CSV, статистика, звук появи картки,
повні налаштування, автозапуск.
